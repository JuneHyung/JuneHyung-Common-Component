<template>
  ...
  <div class="box-wrap">
    ...
    <div class="testBox bg-light-green-13 jh-mx-sm"></div>
    ...
    <div class="testBox bg-brown-4 jh-mx-sm"></div>
    <div class="testBox bg-grey-4 jh-mx-sm"></div>
    <div class="testBox bg-blue-grey-4 jh-mx-sm"></div>
  </div>
